...
class FilmsSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.imdb.com/calendar/?region=FR"]
    ...
    def parse_product(self, response):
        ...
        film_item['realisateur'] = response.css('ul.ipc-metadata-list li div.ipc-metadata-list-item__content-container a::text').get()
        film_item['image'] = response.css('div.ipc-media img::attr(src)').get()
        film_item['date_sortie'] = response.css('div[data-testid="title-details-section"] ul.ipc-metadata-list li div ul li a::text').get()
        film_item['studio'] = response.css('div[data-testid="title-details-section"] ul.ipc-metadata-list li[data-testid="title-details-companies"] div ul li a::text').get()
        film_item['budget'] = response.css('div[data-testid="title-boxoffice-section"] ul li[data-testid="title-boxoffice-budget"] div ul li span::text').get()
        yield film_item
